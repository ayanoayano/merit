...
//受け取る時の件名
define('MAILSUBJECT','買い取りの問合せフォームから送信がありました');

//自動返信の件名
define('REPSUBJECT','「株式会社メリット」買い取りのお問い合わせ受付完了のお知らせ');
...
define('CHECKPAGE','form_buy_submit.php');

//送信完了で表示するページ（mail.phpからのパス）
//define('SUCCESSPAGE','completion.html');
define('SUCCESSPAGE','http://www.toshiba.co.jp/merit/inquiry/form_buy_finish.htm');

//エラーで表示するページ（mail.phpからのパス）
//define('ERRORPAGE','error.php');
define('ERRORPAGE','form_buy_submit.php');
