<?php require_once('confirm2.php');//confim.phpへのパス。無いと動かない。?>
...
<title>買い取りの問合せフォーム | 株式会社メリット</title>
...
<a href="http://www.toshiba.co.jp/merit/index.htm"><img src="../img/common/head/head_logo.jpg" alt="MERIT 株式会社メリット" width="246" height="27" /></a>
...
<div id="contentsArea">
<div class="inner">
<h1><img src="http://www.toshiba.co.jp/merit/inquiry/img/h1_img_buy.jpg" alt="買い取りの問合せフォーム" width="860" height="105" /></h1>
<div class="layout">
<form method="post" action="mail2.php" enctype="multipart/form-data" class="zeromail">
